...
export default function CourseCard({ course }) {
  ...
  const getInstructor = async () => {
    const res = await axios
      .get(
        `http://localhost:3000/instructor/getInstructor?_id=${course.instructor_id}`
      )
    ...
    <div className="border">
      <div className="course-details">
        ...
        <div className="course-text">
          ...
          <h6>
            <label id="light-font">by {instructorName}</label>
          </h6>
          <p>{course.summary}</p>
        </div>
        ...
        <div className="course-info">
          <label>
            <img src={img2} alt="" />
            &nbsp;&nbsp;<span id="bold">{course.totalHours}</span>&nbsp;hours
          </label>
          <label>
            <img src={img3} alt="" />
          ...
          <label>
            <img src={img4} alt="" />
            &nbsp;&nbsp;<span id="bold">{course.level}</span>&nbsp;Level
          </label>
          <label>
            <img src={img3} alt="" />
            &nbsp;&nbsp;<span id="bold">{course.price}</span>&nbsp;EGP
          </label>
        </div>
      </div>
    </div>
